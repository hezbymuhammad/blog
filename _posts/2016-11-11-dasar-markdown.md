...
Caranya mudah. Cukup install perl dan pasang library markdown.
 ...
 4. Compile file markdown dengan perintah
 `perl Markdown.pl --html4tags file_kamu.md`
 Perintah tersebut akan menghasilkan output file html yang dapat kamu buka lewat browser.
